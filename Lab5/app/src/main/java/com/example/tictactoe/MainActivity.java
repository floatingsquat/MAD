...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // bunu butonları teker teker initiliaze etmemek için yaptık
        TableLayout table = findViewById(R.id.board);
        for(int i = 0; i < 3; i++){
            TableRow row =(TableRow) table.getChildAt(i); // first way
            for(int j = 0; j < 3; j++){
                Button button =(Button) row.getChildAt(j); // second way
        ...
        Button btn12 = findViewById(R.id.button11);
